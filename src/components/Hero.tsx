...
export default function Hero() {
  const scrollToProducts = () => {
    trackMetaEvent('Lead', { content_name: 'Hero Order Now Click' });
    const element = document.getElementById('products-section');
    element?.scrollIntoView({ behavior: 'smooth' });
  };

  return (
    <section className="relative flex items-center justify-center overflow-hidden bg-gray-50 pt-4 pb-8 md:py-20 px-4">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        >
          <span className="inline-block px-4 py-1.5 bg-green-100 text-green-700 text-xs sm:text-sm font-bold uppercase tracking-wider rounded-full mb-4 md:mb-6">
            Premium Oxford Cotton
          </span>
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold tracking-tight text-gray-900 mb-4 md:mb-6 leading-[1.1]">
        ...
        <motion.div 
          ...
          className="mt-6 md:mt-16 rounded-3xl overflow-hidden shadow-2xl border-4 border-white"
        >
          <img 
